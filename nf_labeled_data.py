...
nf_patients = meta_df.iloc[508:509,:]

nf_patient_labels = []
for patient_id, acc_num in zip(nf_patients['Patient_ID'], nf_patients['Accession_Number']):
    ...
    for v in volume:
        patient_label = [v, uint8_0]
        nf_patient_labels.append(patient_label)
    
    del plan
    del volume
pickle.dump(nf_patient_labels, open('nf_patient_data.pkl', 'wb'))
